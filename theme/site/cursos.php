...
<input type="checkbox" id="chec">
    ...
    <h1 id="t1"> Conheça nossos Cursos</h1>
    
        <main>
        <section class="container-flex">
            <div class="item1">
                <a href="curso1.php"><img src="imagens/cursos/curso.png" alt="at1" class="icones"/></a>
            </div>
            

            <div class="item2">
                <a href="curso1.php"><img src="imagens/cursos/curso.png" alt="at2"  class="icones"/></a>
            </div>
        </section>

        <section class="container-flex">
        <a href="curso1.php"><p id="ti1">Curso 1</p></a>
        <a href="curso1.php"><p id="ti2">Curso 2</p></a>
        </section>
