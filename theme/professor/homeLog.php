...
<input type="checkbox" id="chec">
    ...
    <nav id="nav">
        <ul id="ul"> 
        <li id="id"><a id="a" href="<?=url("professor/perfil")?>">Perfil</a></li>
        <li id="id"><a id="a" href="<?=url("atividadesProf")?>">Atividades</a></li>
        <li id="id"><a id="a" href="<?=url("cursos/cursosProf")?>">Cursos</a></li>
        <li id="id"><a id="a" href="<?=url("delegacia/delegaciaProf")?>">Delegacia</a></li>
        <li id="id"><a id="a" href="<?=url("noticia/noticiaProf")?>">Divulgações</a></li>
        <li id="id"><a id="a" href="<?=url("professor/home")?>">Fale Conosco</a></li>   
        <li id="id"><a id="a" href="<?=url()?>">Sair</a></li>       
        </ul>
    </nav>
     
    <a href="<?=url("professor/home")?>"><img src="imagens/Atividades/barueri_logo.png" id="logo" alt="logo"></a>
    ...
    <div class="manchete1">
        ...
        <fieldset class="fieldset">
                ...
                <h2 id="ti2"><a href="noticias1Professor.php">Câncer de ovário é tema de palestra na Secretaria da Mulher</a></h2>
                <p id="txt"><a href="noticias1Professor.php">Ter acesso à informação pode salvar vidas e foi com esse objetivo que a Secretaria da Mulher promoveu na segunda-feira (dia 6), no Dia Mundial de Combate ao Câncer de Ovário, uma palestra sobre o tema.</a></p>
    ...
    <br>
        ...
        <fieldset class="fieldset">    
                <h2 id="ti2"><a href="noticias2Professor.php">Premiação marca reconhecimento das mulheres em destaque de Barueri</a></h2>
                <p id="txt"><a href="noticias2Professor.php">Foi muito emocionante a cerimônia do prêmio Mulher em Destaque Barueri, realizado na noite de quinta-feira (2 de maio). O evento, que está em sua segunda edição, conta com a realização da Secretaria da Mulher e tem o apoio do Conselho Municipal da Mulher de Barueri.</a></p>
                <h3 id="tema">Premiação de Destaque</h3>
            </fieldset>    
    </div>
        <div class="corpo">
        <a href="<?=url("atividades/atividadesProf")?>"><img src="imagens/home/natacao.png" id="icone2" alt="atividades" name="atividades"></a>
        <h1 id="titulo">Atividades</h1>
        <h2 id ="texto">No Espaço Mulher temos várias Atividades, como Natação, Musculação, Pilates e Gap.</h2>

        <a href="<?=url("cursos/cursosProf")?>"><img src="imagens/home/Curso.png" id="icone2" alt="cursos" name="cursos"></a>
        ...
        <a href="<?=url("delegacia/delegaciaProf")?>"><img src="imagens/home/Delegacia.png" id="icone3" alt="delegacia" name="delegacia"><a/>
    ...
    <hr class="barra2">
        ...
        <u><a href="<?=url("contato/contatoProf")?>" id="fale">Fale Conosco<a/></u>
            ...
            <u><a href="<?=url("contato/contatoProf")?>" id="sobre">Sobre Nós<a/></u>
    </footer>
</body>
