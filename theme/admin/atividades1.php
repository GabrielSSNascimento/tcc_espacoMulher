...
<input type="checkbox" id="chec">
    ...
    <nav id="nav">
        ...
        <li id="id-subp"><a href="#">Cadastrar</a>
    <ul>
    <li class="id-sub"><a href="admistrador/cadastroAdmin.php">Administrador</a>
    <li class="id-sub"><a href="admistrador/cadastroParticipante.php">Participante</a>
    <li class="id-sub"><a href="admistrador/cadastroProf.php">Professor</a>
    </ul>
    </li>
        ...
        <li id="id" ><a href=".php">Cursos</a></li>
        <li id="id"><a href="delegacia.php">Delegacia</a></li>
        <li id="id"><a href="noticias.php">Divulgações</a></li>
        <li id="id"><a href="FaleConosco.php">Fale Conosco</a></li>  
...
<h2 id="hora">Horários</h2>
    ...
    <section class="container-flex">
            ...
            <div class="item1">
                <a href="updateATV.php"><p><b>Alterar</b></p></a>
            </div>
