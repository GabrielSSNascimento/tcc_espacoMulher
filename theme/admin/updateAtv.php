...
.botao{
    ...
    <title>Alterar Divulgação</title>
</head>
<body>
<header>
...
<body>
<main>
	<!-- value="#" vai ser onde fica as coisas que seram alteradas futuramente (eu sei sou foda)-->
    <section class="content">
		...
		<input type="hidden" name="cod_divu" value="<?= $arrayGetDivu[0][cod_divu] ?>">
                <label>Título da divulgação:</label><br>
                <input type="text" class="field" name="titulo" id="titulo_divu" value="#">
                <label>Descrição da divulgação:</label><br>
                ...
                <label>Data e hora da divulgação:</label><br>
		...
		<input type="hidden" name="cod_divu" value="<?= $arrayGetArq[0][cod_divu] and $arrayGetArq[0][tipo_arq] = "T" ?>">
                <label>Imagens sobre o título:</label><br>
                <input type="file" id="img_title" value="#"><br>
                <label>Legenda do arquivo:</label>
