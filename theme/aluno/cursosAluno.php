...
<input type="checkbox" id="chec">
    ...
    <a href="homelog.php"><img src="imagens/Atividades/barueri_logo.png" id="logo" alt="logo"></a> 
        ...
        <section class="container-flex">
            <div class="item1">
                <a href="curso1Aluno.php"><img src="imagens/cursos/curso.png" alt="at1" class="icones"/></a>
            </div>
            

            <div class="item2">
                <a href="curso1Aluno.php"><img src="imagens/cursos/curso.png" alt="at2"  class="icones"/></a>
            </div>
        </section>

        <section class="container-flex">
        <a href="curso1Aluno.php"><p id="ti1">Curso 1</p></a>
        <a href="curso1Aluno.php"><p id="ti2">Curso 2</p></a>
        </section>
